...
<div class="container mt-4 ">
     <div class="row">
        <div class="col-md-6">
             <a href="" class="text-info bg-light p-2">YEAR 2019</a> &gt; <a href="" class="text-info bg-light p-2"> MONTH JANUARY</a> &gt; <a href="" class="text-info bg-light p-2"><?php echo $_GET['typeofprogramme'] ?></a>
        </div>
        <div class="col-md-6">
            <a href="list-event-details.php?deptid=<?php $deptid =$_GET['deptid']; if(isset($deptid) ) 
															...
															echo $monthid; else die('Some Error') ?>" class="bg-dark text-light p-2 d-block ml-auto w-25" > << GO BACK</a>
        </div>
     </div>
 </div>
            ...
            <div class="container">
                    <div class="card">
                        <div class="card-header">
                             <h6><?php echo $_GET['typeofprogramme'] ?> Programme</h6>
                        </div>
                                                    ...
                                                    <tr class="">
                                                       ...
                                                       <q><?= $row['title'] ?></q>
                                                        ...
                                                        <td><div class="btn-group"><a href="inserting/otherprogramme.php?deptid=<?php $deptid =$_GET['deptid']; if(isset($deptid) ) 
															echo $deptid; else die('Some Error') ?>&amp;yearid=<?php $yearid =$_GET['yearid']; if(isset($deptid) ) 
															echo $yearid; else die('Some Error') ?>&amp;monthid=<?php $monthid =$_GET['monthid']; if(isset($monthid) ) 
															echo $monthid; else die('Some Error') ?>&amp;programme=addoncourse&amp;programmedid=<?= $row['prgmid'] ?>" class="btn btn-sm btn-primary">Edit</a> <button class="btn btn-sm btn-danger delete" value="<?= $row['prgmid'] ?>" > Delete</button> <a href="" class="btn btn-sm btn-success">Report</a> 
                        ...
                        <div class="card-footer p-0 bg-primary" >
                            <a class="btn d-block w-100 mx-auto text-white" href="inserting/otherprogramme.php?deptid=<?php $deptid =$_GET['deptid']; if(isset($deptid) ) 
															echo $deptid; else die('Some Error') ?>&amp;yearid=<?php $yearid =$_GET['yearid']; if(isset($deptid) ) 
															echo $yearid; else die('Some Error') ?>&amp;monthid=<?php $monthid =$_GET['monthid']; if(isset($monthid) ) 
															echo $monthid; else die('Some Error') ?>&amp;programme=addoncourse&userid=<?=$userid?>">ADD</a>
