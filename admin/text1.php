...
// fetching the monthname
    $months = mysqli_query("select * from month where monthid=$monthid");
    while($month=mysqli_fetch_assoc($months)){
        $temp = $month['monthname'];
    }
    //fetching the year 
    $years = mysqli_query("select * from year where yearid=$yearid");
    while($yearr=mysqli_fetch_assoc($years)){
        $year = $yearr['year'];
    }
    // fetching the department
    $departments = mysqli_query("select * from department where deptId=$deptid");
    while($dept=mysqli_fetch_assoc($departments)){
        $deptname = $dept['deptname'];
        $grad = $dept['graduation'];
    }
...
// checking for interactive programme is present or not.
        $interactives= "select * from programmes where yearid = '$yearid' and monthid = '$monthid' and deptid = '$deptid' and typeofprogramme = 'Interactive'";
        ...
        $interactives= "select * from programmes where yearid = '$yearid' and monthid = '$monthid' and deptid = '$deptid' and typeofprogramme = 'constructive'";
        $intresult = mysqli_query($conn, $interactives);
        if (mysqli_num_rows($intresult) > 0) {
            // output data of each row
        ...
        $interactives= "select * from programmes where yearid = '$yearid' and monthid = '$monthid' and deptid = '$deptid' and typeofprogramme = 'experiential'";
        $intresult = mysqli_query($conn, $interactives);
        if (mysqli_num_rows($intresult) > 0) {
            // output data of each row
        ...
        $interactives= "select * from programmes where yearid = '$yearid' and monthid = '$monthid' and deptid = '$deptid' and typeofprogramme = 'addoncourse'";
        $intresult = mysqli_query($conn, $interactives);
        if (mysqli_num_rows($intresult) > 0) {
            // output data of each row
        ...
        $interactives= "select * from fest where yearid = '$yearid' and monthid = '$monthid' and deptid = '$deptid'";
        $intresult = mysqli_query($conn, $interactives);
        if (mysqli_num_rows($intresult) > 0) {
        //     // output data of each row
        ...
        $interactives= "select * from achievements where yearid = '$yearid' and monthid = '$monthid' and deptid = '$deptid' and ach_type='Student'";
        $intresult = mysqli_query($conn, $interactives);
        if (mysqli_num_rows($intresult) > 0) {
        ...
        $interactives= "select * from achievements where yearid = '$yearid' and monthid = '$monthid' and deptid = '$deptid' and ach_type='Faculty'";
        $intresult = mysqli_query($conn, $interactives);
        if (mysqli_num_rows($intresult) > 0) {
        ...
        $interactives= "select * from publication where yearid = '$yearid' and monthid = '$monthid' and deptid = '$deptid' and pubtype='BOOK'";
        $intresult = mysqli_query($conn, $interactives);
        if (mysqli_num_rows($intresult) > 0) {
        ...
        // chapter OR ARTICLE
        $interactives= "select * from publication where yearid = '$yearid' and monthid = '$monthid' and deptid = '$deptid' and pubtype='CHAPTER' or pubtype='ARTICLE'";
        $intresult = mysqli_query($conn, $interactives);
        if (mysqli_num_rows($intresult) > 0) {
        ...
        // paper publications
        //$section->addText('VIII. Publications by faculty members ',$header);
        $interactives= "select * from publication where yearid = '$yearid' and monthid = '$monthid' and deptid = '$deptid' and pubtype='PAPER'";
        $intresult = mysqli_query($conn, $interactives);
        if (mysqli_num_rows($intresult) > 0) {
        ...
        $interactives= "select * from researchproject where yearid = '$yearid' and monthid = '$monthid' and deptid = '$deptid'";
        $intresult = mysqli_query($conn, $interactives);
        if (mysqli_num_rows($intresult) > 0) {
